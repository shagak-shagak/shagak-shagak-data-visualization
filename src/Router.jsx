...
import MBTI from "./pages/chartjs/10_MBTI";
import MixedChart from "./pages/chartjs/06_MixedChart";
import Olympic from "./pages/chartjs/08_Olympic";
import PieChart from "./pages/chartjs/09_PieChart";
import PolarAreaChart from "./pages/chartjs/07_PolarAreaChart";
import RadarChart from "./pages/chartjs/08_RadarChart";
import ScatterChart from "./pages/chartjs/09_ScatterChart";
